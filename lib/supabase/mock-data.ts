export const DEFAULT_MOCK_SESSIONS = [
  // --- TIMED SESSIONS ---
  {
    ...
    correct_count: 8, total_count: 8, accuracy: 100, percentile: 99.1,
  ...
  },
  {
    ...
    correct_count: 14, total_count: 16, accuracy: 87.5, percentile: 85.0,
  ...
  },
  {
    ...
    correct_count: 22, total_count: 25, accuracy: 88, percentile: 82.3,
  ...
  },
  {
    ...
    correct_count: 55, total_count: 58, accuracy: 94.8, percentile: 92.5,
  ...
  // --- FIXED SESSIONS ---
  {
    ...
    correct_count: 10, total_count: 10, accuracy: 100, percentile: 98.5,
  ...
  },
  {
    ...
    correct_count: 23, total_count: 25, accuracy: 92, percentile: 88.0,
  ...
  },
  {
    ...
    correct_count: 48, total_count: 50, accuracy: 96, percentile: 95.5,
  ...
  },
  {
    ...
    correct_count: 95, total_count: 100, accuracy: 95, percentile: 94.0,
  ...
  // --- EXTRA ENTRIES FOR OTHER USERS (For Leaderboard Variety) ---
  {
    ...
    operator_set: ["addition", "subtraction"], allow_negatives: false,
    session_mode: "timed", duration_seconds: 15, question_limit: null,
    correct_count: 12, total_count: 12, accuracy: 100, percentile: 99.9,
  ...
  },
  {
    ...
    operator_set: ["addition", "subtraction", "multiplication", "division"], allow_negatives: true,
    session_mode: "fixed", duration_seconds: null, question_limit: 50,
    correct_count: 50, total_count: 50, accuracy: 100, percentile: 99.9,

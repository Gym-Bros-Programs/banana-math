...
describe('MonkeyMath Component', () => {
  const mockQuestions = [
    { id: '1', question_text: '2 + 2', correct_answer: '4', category: 'arithmetic', sub_type: 'addition' },
    { id: '2', question_text: '5 - 3', correct_answer: '2', category: 'arithmetic', sub_type: 'subtraction' },
  ]
